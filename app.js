...
// TODO: After viewing the previous console.log(), return the code to a working state.
 ...
 //greeting = () => 'Hi  this is greeting ${this.name}'
...
// point to the class methode or arrtibute
// 2. What is "this" when joe.scopeArrow() is invoked?
// point to the instance (or the class itself, for static fields). However, because it is a closure, not the function's own binding, the value of this will not change based on the execution context.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not have their own this , Because a class's body has a this context